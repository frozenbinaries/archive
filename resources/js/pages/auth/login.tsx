            ...
            <div className="fixed inset-0 z-0 flex overflow-y-auto bg-[#E6E2D6] font-[Inter] text-[#151A21] dark:bg-[#12151A] dark:text-[#ECE7DA]">
                    ...
                    <div className="w-full max-w-md">
                        ...
                        <div className="flex flex-col gap-6">
                            {status && (
                                <div
                                    role="status"
                                    className="flex items-center gap-3 border-l-2 border-emerald-500 bg-muted/40 px-4 py-2 text-sm font-medium text-emerald-700 dark:text-emerald-400"
                                >
                            ...
                            <div className="flex items-center gap-3">
                                <span className="h-px flex-1 bg-[#D6D0BF] dark:bg-[#2C313A]" />
                                <span className="font-[IBM_Plex_Mono] text-[10px] uppercase tracking-wider text-[#6E6A5C] dark:text-[#A39D8C]">
                                    or use a password
                                </span>
                                <span className="h-px flex-1 bg-[#D6D0BF] dark:bg-[#2C313A]" />
                            </div>
                                ...
                                {({ processing, errors }) => (
                                    <>
                                            ...
                                            <div className="relative grid gap-2">
                                                ...
                                                <div className="flex items-baseline justify-between">
                                                    ...
                                                    {canResetPassword && (
                                                        <TextLink
                                                            href={request()}
                                                            className="text-sm text-[#A6392C] hover:text-[#8A2E23]"
                                                            tabIndex={5}
                                                        >
                                        ...
                                        <div className="flex flex-col gap-5 border-t border-[#D6D0BF] pt-5 dark:border-[#2C313A]">
                                            <Label
                                                htmlFor="remember"
                                                className="flex w-fit cursor-pointer items-center gap-3 font-normal"
                                            >
                                                <Checkbox
                                                    id="remember"
                                                    name="remember"
                                                    tabIndex={3}
                                                    className="border-[#D6D0BF] data-[state=checked]:border-[#A6392C] data-[state=checked]:bg-[#A6392C] dark:border-[#2C313A]"
                                                />
                                                Remember me
                                            </Label>
                                            ...
                                            >
                                                {processing ? (
                                                    ...
                                                    <svg
                                                        className="h-4 w-4 shrink-0 transition-transform duration-200 group-hover:-rotate-6"
                                                        viewBox="0 0 24 24"
                                                        fill="none"
                                                        stroke="currentColor"
                                                        strokeWidth="1.8"
                ...
                <div className="flex w-1/2 flex-col items-center justify-between bg-[#E6E2D6] p-12 dark:bg-[#12151A] lg:p-16">
                    ...
                    <div className="flex flex-1 flex-col items-center justify-center gap-8 py-8">
                        <div className="space-y-4 text-center">
                            <h1 className="font-[Fraunces] text-4xl font-semibold leading-[1.05] tracking-tight lg:text-5xl">
                                Welcome back to
                                <span className="block text-[#A6392C]">your archive.</span>
                            </h1>
                            <p className="text-base leading-relaxed text-[#6E6A5C] dark:text-[#A39D8C] lg:text-lg">
                                Every file, properly filed. Every version, tracked.
                            </p>
                        </div>

                        {/* Index card stack with flip effect */}
                        <div className="relative h-72 w-full max-w-sm lg:h-80">
                            ...
                            <div className="relative h-full w-full perspective-1000">
                                ...
                                >
                                    {/* Front */}
                                    <div
                                        className={`absolute inset-0 backface-hidden rounded-lg border border-[#D6D0BF] bg-[#F1EDE1] p-6 shadow-lg dark:border-[#2C313A] dark:bg-[#1B1F26] ${
                                            isFlipping ? 'invisible' : 'visible'
                                        }`}
                                    >
                                    ...
                                    {/* Back */}
                                    <div
                                        className={`absolute inset-0 backface-hidden rotate-y-180 rounded-lg border border-[#D6D0BF] bg-[#F1EDE1] p-6 shadow-lg dark:border-[#2C313A] dark:bg-[#1B1F26] ${
                                            isFlipping ? 'visible' : 'invisible'
                                        }`}
                                    >
                                        <div className="flex items-start justify-between font-[IBM_Plex_Mono] text-[11px] uppercase tracking-wider text-[#6E6A5C] dark:text-[#A39D8C]">
                                            <span>Call No.</span>
                                ...
                                {FILES.map((_, index) => (
                                    <button
                                        ...
                                        className={`h-2 w-2 rounded-full transition-all ${
                                            index === currentIndex
                                                ? 'w-6 bg-[#A6392C]'
                                                : 'bg-[#D6D0BF] hover:bg-[#AD8B52] dark:bg-[#2C313A]'
                                        }`}
                        ...
                        <div className="grid w-full max-w-sm grid-cols-2 gap-6 border-t border-[#D6D0BF] pt-6 dark:border-[#2C313A]">
                            <div className="text-center">
                                <div className="font-[Fraunces] text-2xl font-semibold text-[#A6392C]">50,000+</div>
                                <div className="font-[IBM_Plex_Mono] text-[10px] uppercase tracking-wider text-[#6E6A5C] dark:text-[#A39D8C]">
                                    Documents filed
                                </div>
                            </div>
                            <div className="text-center">
                                <div className="font-[Fraunces] text-2xl font-semibold text-[#A6392C]">99.9%</div>
                                <div className="font-[IBM_Plex_Mono] text-[10px] uppercase tracking-wider text-[#6E6A5C] dark:text-[#A39D8C]">
                                    Uptime
                                </div>
                            </div>
                    ...
                    <div className="flex w-full justify-center gap-6 text-xs text-[#6E6A5C] dark:text-[#A39D8C]">
                        <span className="font-[IBM_Plex_Mono] uppercase tracking-wider">Secure &bull; Encrypted</span>
                        <span className="h-4 w-px bg-[#D6D0BF] dark:bg-[#2C313A]" />
                        <span className="font-[IBM_Plex_Mono] uppercase tracking-wider">Rated 4.9 / 5.0</span>
                    </div>
                </div>
            </div>
